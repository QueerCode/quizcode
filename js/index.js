...
$( function() {
  $('body').click( function() {
    $(this).css('background-image', 'url(https://github.com/QueerCode/quizcode/blob/src/images/background_quiz.gif?raw=true)')
  } );
} );
...
$('#quiz').quiz({
  ...
  questions: [
	...
	},
    {
      ...
      'correctIndex': 2,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Cate Blanchett</b></p>L’actrice américaine y incarne une héroïne hétérosexuelle, un stéréotype de la française aux mœurs légères, bien loin de l’identité et de l’orientation sexuelle de Rose Valland."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Cate Blanchett</b></p>L’actrice américaine y incarne une héroïne hétérosexuelle, un stéréotype de la française aux mœurs légères, bien loin de l’identité et de l’orientation sexuelle de Rose Valland.")
   	},
    {
    ...
    },
	{
      ...
      'correctIndex': 2,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Claude Cahun et Marcel Moore</b></p>Après plusieurs années de résistance, elles furent arrêtées et condamnées à mort par les nazis. Elles furent sauvées d’extrême justesse à la libération du territoire. Durant leur emprisonnement, elles continuèrent de résister et à appeler à la désertion les soldats allemands qui les gardaient. La santé de Claude Cahun fut très affectée par cet emprisonnement."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Claude Cahun et Marcel Moore</b></p>Après plusieurs années de résistance, elles furent arrêtées et condamnées à mort par les nazis. Elles furent sauvées d’extrême justesse à la libération du territoire. Durant leur emprisonnement, elles continuèrent de résister et à appeler à la désertion les soldats allemands qui les gardaient. La santé de Claude Cahun fut très affectée par cet emprisonnement.")
    },
	{
      ...
      'correctIndex': 1,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Suzy Solidor</b></p>Elle aura chanté au début de la guerre sur le front pour les soldats français, puis dans son cabaret devant des officiers nazis et sur Radio Paris (radio de propagande durant l’occupation). En 1942, son interprétation de <I>Lili Marleen</I> devient une chanson culte tant pour les soldats allemands que pour les soldats des armées alliées."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Suzy Solidor</b></p>Elle aura chanté au début de la guerre sur le front pour les soldats français, puis dans son cabaret devant des officiers nazis et sur Radio Paris (radio de propagande durant l’occupation). En 1942, son interprétation de <I>Lili Marleen</I> devient une chanson culte tant pour les soldats allemands que pour les soldats des armées alliées.")
    },
	{
      ...
      'correctIndex': 2,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Aide apportée à des femmes, notamment juives, à mettre au monde leurs enfants</b></p>Elisabeth Eindenbenz organisa une maternité à Elne de 1939 à 1944 dans les Pyrénées orientales avec une équipe et l’aide de Secours Suisse aux Enfants et du Croix Rouge Suisse pour venir en aide aux femmes et à leurs enfants fuyant la Guerre d’Espagne et le Franquisme. Elles sauvèrent plus de 600 enfants de 22 nationalités (dont 200 enfants juifs) et aidèrent leurs mères. Elisabeth Eindenbenz a enfreint le règlement (de l’époque) de neutralité et de non-ingérence de la Croix Rouge Suisse en secourant les femmes juives et les réfugiées politiques et pour le contourner elles falsifièrent entre autre les identités des patient.e.s."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Aide apportée à des femmes, notamment juives, à mettre au monde leurs enfants</b></p>Elisabeth Eindenbenz organisa une maternité à Elne de 1939 à 1944 dans les Pyrénées orientales avec une équipe et l’aide de Secours Suisse aux Enfants et du Croix Rouge Suisse pour venir en aide aux femmes et à leurs enfants fuyant la Guerre d’Espagne et le Franquisme. Elles sauvèrent plus de 600 enfants de 22 nationalités (dont 200 enfants juifs) et aidèrent leurs mères. Elisabeth Eindenbenz a enfreint le règlement (de l’époque) de neutralité et de non-ingérence de la Croix Rouge Suisse en secourant les femmes juives et les réfugiées politiques et pour le contourner elles falsifièrent entre autre les identités des patient.e.s.")
    },
	{
      ...
      'correctIndex': 0,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b><I>The night Watch</I> ou <I>Ronde de nuit</I> pour l’édition française</b></p>Ce roman de Sarah Waters, publié en 2006, plonge les lectrices/teurs dans un Londres de 1941, sous les bombardements allemands, et les connections entre quatre Londoniens - trois femmes et un jeune homme, leurs vies et leurs secrets."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b><I>The night Watch</I> ou <I>Ronde de nuit</I> pour l’édition française</b></p>Ce roman de Sarah Waters, publié en 2006, plonge les lectrices/teurs dans un Londres de 1941, sous les bombardements allemands, et les connections entre quatre Londoniens - trois femmes et un jeune homme, leurs vies et leurs secrets.")
    },
	{
      ...
      'correctIndex': 1,
      'correctResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_correct.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Pour les 70 ans de la libération des camps de concentration</b></p>Le site a été créé afin de relier et de rendre visibles les travaux d’activistes féministes, d’artistes, de performeuses, d’historien.ne.s, de sociologues… et pour partager une démarche collective et féministe d’écriture de notre histoire."),
      'incorrectResponse': ('<img src="https://github.com/QueerCode/quizcode/blob/src/images/licorne_incorrect.PNG?raw=true" alt="" style="float:left;"/>' + "<p><b>Pour les 70 ans de la libération des camps de concentration</b></p>Le site a été créé afin de relier et de rendre visibles les travaux d’activistes féministes, d’artistes, de performeuses, d’historien.ne.s, de sociologues… et pour partager une démarche collective et féministe d’écriture de notre histoire.")
    },
	{
