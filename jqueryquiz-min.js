  ...
  $.quiz = function(el, options) {
    ...
    base.methods = {
      ...
      setup: function() {
        ...
        quizHtml += '<a href="#" id="quiz-next-btn">Suivant</a>';
        quizHtml += '<a href="#" id="quiz-finish-btn">Terminer</a>';
        quizHtml += '<a href="#" id="quiz-restart-btn">Recommencer</a>';
        quizHtml += '</div>';
        quizHtml += '</div>';
      ...
      gameOver: function(response) {
        ...
        if ($(gameOverScreen).length === 0) {
          ...
          quizHtml += '<p><a href="#" id="quiz-retry-btn">Recommencer</a></p>';
          quizHtml += '</div>';
      ...
      finish: function() {
        ...
        $(resultsScreen).show();
          $('#quiz-results').html('<img src="https://cdn.rawgit.com/QueerCode/quizcode/src/images/resultats_queerquiz00.png?raw=true"/>' + '<p>Votre score est de ' + score + ' sur ' + numQuestions + '.</p>' + " Merci d’avoir pris du temps pour répondre à nos questions.\n N’hésitez pas à nous écrire à contact@queercode.net ou via le formulaire de contact, pour nous faire part de vos remarques, encouragements, suggestions… <br/>L’équipe de Queercode continue à se poser des questions concernant l’Histoire et nous vous invitons à chercher les réponses avec nous ! Bienvenue !");
